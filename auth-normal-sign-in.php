<?php
    ...
    if ($login != "" && $pass != "") {
        if ($db->userIsExist($login, $pass) == 1) {
            $signIn = new SignIn();
                    ...
                    <form class="md-float-material" method="post">
                        <div class="auth-box">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-left txt-primary">Вход</h3>
                                </div>
                            </div>
                            <hr/>
                            ...
                            <div class="row m-t-25 text-left">
                                <div class="col-sm-5 col-xs-12 forgot-phone text-right">
                                    <a href="auth-sign-up.php" class="text-right f-w-600 text-inverse">Зарегистрироваться</a>
                                </div>
                            </div>
